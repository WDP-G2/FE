...
export function mapViolationFromApi(raw) {
  ...
  const mapped = {
    ...
    participantId: raw?.participantId != null ? String(raw.participantId) : null,
    ...
    severityCode: raw?.severityCode || '',
    resultAction: raw?.resultAction || 'NONE',
    timePenaltyMillis: Number(raw?.timePenaltyMillis || 0),
